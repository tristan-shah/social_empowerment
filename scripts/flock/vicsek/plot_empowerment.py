...
if __name__ == '__main__':
    ...
    passive_path = Path('/Users/tristanshah/Desktop/code/social_empowerment/results/Vicsek/D=0.0-J=0.1-alpha=0.01-behavior=passive-grid_size=5.0-horizon=5-num_agents=125-observation_noise=1.0-power_density=2.0-radius=0.5-seed=6-speed=1.0-steps=4000/empowerment_hist.npy')
    ...
    ax.set_title('Mean Empowerment ± Standard Deviation', fontweight='bold')
    ax.legend()
    ax.grid(alpha = 0.3)
    plt.tight_layout()
