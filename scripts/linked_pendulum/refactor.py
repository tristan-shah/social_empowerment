...
def main(args):
    ...
    # # jnp.save(f'seed={seed}-ave-empowerment.npy', empowerment)
    # # jnp.save(f'seed={seed}-ave-X.npy', X)

    # jnp.save(f'seed={seed}-solo-empowerment.npy', empowerment)
    # jnp.save(f'seed={seed}-solo-X.npy', X)
    ...
    # ## plot empowerment
    # ax[0].plot(E[:, 0], label = 'Left Agent', color = 'blue')
    # ax[0].plot(E[:, 1], label = 'Right Agent', color = 'orange')
