...
# from soc_emp.empowerment import compute_F, waterfilling_implicit
from soc_emp.empowerment import split_channel_matrix
...
if __name__ == '__main__':
    ...
    split_channel_matrix(F, num_agents)

    # S_agent = einsum(F_agent, F_agent, 'a x1 t u, a x2 t u -> a x1 x2')
    # print(
    #     jnp.linalg.eigvalsh(S_agent)
    # )
